  ...
  def change do
    create table(:nas) do
      ...
      add :type, :string,
        default: "other",
        comment:
          "The type of NAS, which can be useful for identifying different kinds of NAS devices."

      add :ports, :integer, comment: "The number of ports available on the NAS."

      add :secret, :string,
        null: false,
        comment: "The shared secret used for communication between the NAS and the RADIUS server."
      ...
      add :description, :string,
        comment: "A description of the NAS, which can provide additional context or details."
