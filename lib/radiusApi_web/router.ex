defmodule RadiusApiWeb.Router do
  ...
  scope "/api", RadiusApiWeb do
    ...
    post "/users/:id/devices", UserController, :create_user_device

    put "/devices/:id", UserController, :update_device
    ...
    post "/network/remove/user", NetworkController, :remove_from_network
  end
